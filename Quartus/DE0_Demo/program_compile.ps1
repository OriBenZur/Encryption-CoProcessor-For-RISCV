riscv64-unknown-elf-gcc -Ttext=0 -march=rv32i -mabi=ilp32 -g .\lock_interference_test.c -o test
riscv64-unknown-elf-objdump -d -S test > test.dump
riscv64-unknown-elf-gcc -Ttext=0 -march=rv32i -mabi=ilp32 .\lock_interference_test.c -o test
