...
# KEY
#============================================================
# set_instance_assignment -name IO_STANDARD "3.3 V SCHMITT TRIGGER" -to ORG_BUTTON[0]
# set_instance_assignment -name IO_STANDARD "3.3 V SCHMITT TRIGGER" -to ORG_BUTTON[1]
set_location_assignment PIN_B8 -to ORG_BUTTON[0]
set_location_assignment PIN_A7 -to ORG_BUTTON[1]
